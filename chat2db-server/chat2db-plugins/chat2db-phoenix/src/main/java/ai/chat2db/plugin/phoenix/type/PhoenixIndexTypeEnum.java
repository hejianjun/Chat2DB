...
public enum PhoenixIndexTypeEnum {
    ...
    PhoenixIndexTypeEnum(String name, String keyword) {
        this.name = name;
        this.keyword = keyword;
        this.indexType =new IndexType(name);
    }

    public static PhoenixIndexTypeEnum getByType(String type) {
        for (PhoenixIndexTypeEnum value : PhoenixIndexTypeEnum.values()) {
    ...
    public static List<IndexType> getIndexTypes() {
        return Arrays.asList(PhoenixIndexTypeEnum.values()).stream().map(PhoenixIndexTypeEnum::getIndexType).collect(java.util.stream.Collectors.toList());
    }
