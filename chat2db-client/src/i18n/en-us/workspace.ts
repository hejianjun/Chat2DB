export default {
  ...
  'workspace.erDiagram.inferVirtualFkSuccess': 'Successfully inferred {0} virtual foreign key(s)',
  ...
  'workspace.erDiagram.confirmDeleteVirtualFk': 'Are you sure you want to delete the virtual foreign key "{0}"?',
