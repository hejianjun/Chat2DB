export default {
  ...
  'workspace.menu.viewTableRelation': 'View Table Relations',
  ...
  'workspace.tableRelation.masterTable': 'Master Table',
  'workspace.tableRelation.uniqueColumn': 'Unique Column',
  ...
  'workspace.tableRelation.deleteVirtualConfirmContent': 'Delete this virtual foreign key?',
  'workspace.tableRelation.deleteRealConfirmContent':
    'Delete this real foreign key record? The required DDL will be returned.',
  'workspace.tableRelation.realDeleteDDLTitle': 'Drop Real Foreign Key DDL',
  'workspace.tableRelation.deleteSuccess': 'Foreign key deleted',
  'workspace.tableRelation.createSuccess': 'Foreign key added',
  'workspace.tableRelation.createError': 'Failed to add foreign key',
  'workspace.tableRelation.updateSuccess': 'Virtual foreign key updated',
  'workspace.tableRelation.updateError': 'Failed to update virtual foreign key',
  'workspace.tableRelation.importVirtualFk': 'Import Virtual FK',
  'workspace.tableRelation.exportVirtualFk': 'Export Virtual FK',
  ...
  'workspace.tableRelation.deleteAllVirtualFk': 'Delete All Virtual FKs',
  'workspace.tableRelation.deleteAllVirtualConfirmTitle': 'Delete All Virtual FKs',
  'workspace.tableRelation.deleteAllVirtualConfirmContent': 'Delete {1} virtual foreign key(s) in the current list?',
  'workspace.tableRelation.deleteAllVirtualSuccess': 'All virtual foreign keys deleted',
  'workspace.tableRelation.deleteAllVirtualError': 'Failed to delete all virtual foreign keys',
