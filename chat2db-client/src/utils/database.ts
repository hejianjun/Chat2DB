 ...
 * @returns
 */
export function compatibleDataBaseName(databaseName: string, databaseType: DatabaseTypeCode, schemaName: string = '') {
  ...
  if (
    ...
    return `\`${databaseName}\``;
  } else if ([DatabaseTypeCode.PHOENIX].includes(databaseType)) {
